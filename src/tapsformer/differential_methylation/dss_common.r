...
bioc_packages <- c(
    ...
    "TxDb.Hsapiens.UCSC.hg38.knownGene", "AnnotationHub", "BiocParallel","DMRcate"
)
cran_packages <- c("minfi", "Biobase","data.table", "futile.logger", "parallel", "dplyr", "tidyr", "ggplot2", "svglite", "pheatmap", "grid", "gridExtra")
